    ...
    <div class="modal-content">
      <form id="formVoucher" method="post">
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            <label class="form-label">Deskripsi Voucher</label>
            <textarea class="form-control" name="deskripsiVoucher" rows="3" required></textarea>
          </div>
          <div class="mb-3">
            <label class="form-label">Tanggal Kedaluwarsa</label>
            <input type="date" class="form-control" name="tanggalKedaluwarsa" required>
          </div>
          <div class="mb-3">
            <label class="form-label">Jenis Potongan</label><br>
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="radio" name="jenisPotongan" id="radioRp" value="rp" checked>
              <label class="form-check-label" for="radioRp">Potongan Harga (Rp)</label>
            </div>
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="radio" name="jenisPotongan" id="radioPersen" value="persen">
              <label class="form-check-label" for="radioPersen">Potongan Harga (%)</label>
            </div>
          </div>
          <div class="mb-3" id="inputPotonganRp">
            <label class="form-label">Jumlah Potongan (Rp)</label>
            <input type="number" class="form-control" name="potonganRp" min="0">
          </div>
...
<script>
  ...
  document.getElementById("radioPersen").addEventListener("change", function () {
